				...
				<div class="row">
					...
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<input type="text" pattern=".*" class="form-control" name="item_nombre_up" value="<?php echo $campos['item_nombre']; ?>" id="item_nombre" maxlength="140">
						</div>
					</div>
					...
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<input type="text" pattern=".*" class="form-control" name="item_detalle_up" value="<?php echo $campos['item_detalle']; ?>" id="item_detalle" maxlength="190">
						</div>
					</div>
					...
					<div class="col-12 col-md-6" style="display: none;">
						<div class="form-group">
							...
							<input type="num" pattern="[0-9]{1,9}" class="form-control" name="item_stock_up" value="<?php echo $campos['item_stock']; ?>" id="item_stock" maxlength="9" >
						</div>
					</div>

					<div class="col-12 col-md-6">
						<div class="form-group">
							<label for="item_patrimonio" class="bmd-label-floating">Patrimonio</label>
							<input type="text" pattern="[a-zA-Z0-9-]{1,45}" class="form-control" name="item_patrimonio_up" value="<?php echo $campos['item_patrimonio']; ?>" id="item_patrimonio" maxlength="45" onkeydown="reemplazarEnterPorTab(event)">
						</div>
					</div>
					<script type="text/javascript">
						function reemplazarEnterPorTab(event) {
							if (event.keyCode === 13) {
					...
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<input type="text" pattern="[a-zA-Z0-9-]{1,45}" class="form-control" name="item_codigo_up" value="<?php echo $campos['item_codigo']; ?>" id="item_codigo" maxlength="45">
						</div>
					</div>
