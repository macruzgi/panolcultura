				...
				<div class="row">
					<div class="col-12 col-md-6">
						<div class="form-group">
							<label for="item_nombre" class="bmd-label-floating">Nombre, Marca y/o Modelo</label>
							<input type="text" pattern=".*" class="form-control" name="item_nombre_reg" id="item_nombre" maxlength="140">
						</div>
					</div>
					<div class="col-12 col-md-6">
						<div class="form-group">
							<label for="item_detalle" class="bmd-label-floating">Detalle/Mas Información</label>
							<input type="text" pattern=".*" class="form-control" name="item_detalle_reg" id="item_detalle" maxlength="190">
						</div>
					</div>
					<div class="col-12 col-md-4"  style="display: none;">
						<div class="form-group">
							<label for="item_stock" class="bmd-label-floating">Stock</label>
							<input type="num" pattern="[0-9]{1,9}" class="form-control" name="item_stock_reg" id="item_stock" maxlength="9" value="1" readonly>
						</div>
					</div>
					...
					<div class="col-12 col-md-2" >
						<div class="form-group">
							...
							<select class="form-control" name="item_estado_reg" id="item_estado" readonly>
					...
					<div class="col-12 col-md-5">
						<div class="form-group">
							...
							<input type="text" pattern="[a-zA-Z0-9-]{1,45}" class="form-control" name="item_patrimonio_reg" id="item_patrimonio" maxlength="45" onkeydown="reemplazarEnterPorTab(event)">
						</div>
					</div>
